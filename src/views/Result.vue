<template>
  <v-container class="py-6 py-lg-12 text-center">
    ...
    <h2 class="text-h6 text-sm-h5 secondary--text mt-4 w-full w-md-8-12 w-xl-half mx-auto">Overall {{this.results[1]}}/{{this.results[0]}} correct. In percentage you got {{this.percent}}% correct.</h2>
    <div class="mt-4">
      <v-btn x-large class="my-1 mx-sm-1 w-full w-sm-auto" color="primary" @click="newGame">Play Again</v-btn>
    </div>
  </v-container>
</template>
<script>
